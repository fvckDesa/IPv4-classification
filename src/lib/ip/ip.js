...
["_main","_make_IP","___getTypeName","__embind_initialize_bindings","_fflush","onRuntimeInitialized"].forEach((prop) => {
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'ip.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('ip.wasm', import.meta.url).href;
}
...
/** @type {function(...*):?} */
var _make_IP = Module["_make_IP"] = createExportWrapper("make_IP");
/** @type {function(...*):?} */
